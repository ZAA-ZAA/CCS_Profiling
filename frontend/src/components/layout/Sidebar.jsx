          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-orange-100 text-orange-700">
              ...
              <div className="min-w-0 text-left">
                <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-gray-400">Signed In As</p>
                <p className="truncate text-sm font-bold text-gray-800">{displayRole}</p>
              </div>
            </div>
