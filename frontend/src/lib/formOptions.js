...
export const VIOLATION_SEVERITIES = ['Low', 'Moderate', 'High', 'Critical'];
export const AFFILIATION_CATEGORIES = ['Organization', 'Sports', 'Team', 'Club'];
export const AFFILIATION_ROLES = ['Member', 'Officer', 'Captain', 'Volunteer', 'Lead'];
